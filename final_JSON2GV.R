...
json_file <- fromJSON('philosophers.json')
json_file <- json_file[2]$results$bindings
json_file <- data.frame(json_file$Philosopher$value, json_file$influenced$value, json_file$birthDate$value)
