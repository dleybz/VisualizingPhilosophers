...
#These lines clean up the values in the second column we need
...
#These lines clean up the values in the third column we need
...
relationships<-paste("")
#This line creates a vector which we will use in the next section, and in this section fill with all of the people who were not influenced by anybody
ancestors_vector<-vector()
#This line fills the character string and vector created above
...
##Ancestors:
#This line creates a character string which we will fill with all of the people who were not influenced by anybody
ancestors <- paste("")
#This line fills the character string with each person who was not influenced by anybody
